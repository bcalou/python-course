...
# Pour cela, il suffit de passer le deuxième tableau en paramètre
# supplémentaire de la fonction map() :
...
print('\033[92m✓ OK\033[00m' if total_cost == [150, 4, 20]  else '\033[91m❌KO\033[00m')
