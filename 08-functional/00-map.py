...
# Avec un peu d'habitude, elle peut simplifier - dans certains cas -
...
# Cette approche, qui se base plutôt sur des opérations que sur la
# programmation impérative classique, fait partie de l'approche appelée
...
print('\033[92m✓ OK\033[00m' if powers_of_two == [32, 8192, 16, 2, 4096] else '\033[91m❌KO\033[00m')
