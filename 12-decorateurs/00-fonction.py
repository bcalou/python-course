...
def get_number_generator() -> Callable[[], int]:
    ...
    # Fonction définie dans le scope de get_number_generator
    def generate_number():
        print("Je suis la fonction interne et renvoyée")
        return 8

    # On retourne la fonction (sans parenthèses, pas d'exécution ici)
...
# C'est ce qu'on appelle une closure : l'encapsulation d'un scope.
...
print('\033[92m✓ OK\033[00m' if get_hello_generator(True)() == "Bonjour" and get_hello_generator(False)() == "Hello" else '\033[91m❌KO\033[00m')
