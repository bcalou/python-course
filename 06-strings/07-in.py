...
print('\033[92m✓ OK\033[00m' if is_valid_sentence("Bien le bonjour") and not is_valid_sentence("Mince alors !") and not is_valid_sentence("Je suis en retard, fichtre !") else '\033[91m❌KO\033[00m')
