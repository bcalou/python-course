...
print('\033[92m✓ OK' if replace_with_roman_numerals("Bonjour") == "Bonjour" and replace_with_roman_numerals("Je lis le chapitre 4") == "Je lis le chapitre IV" and replace_with_roman_numerals("5 janvier") == "V janvier" else '\033[91m❌KO')