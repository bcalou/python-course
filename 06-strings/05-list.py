...
print('\033[92m✓ OK\033[00m' if is_valid_time('23:59') and is_valid_time('00:00') and not is_valid_time('2:4') and not is_valid_time('25:00') and not is_valid_time('ab:cd') else '\033[91m❌KO\033[00m')
