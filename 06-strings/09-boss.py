...
print('\033[92m✓ OK\033[00m' if is_valid_password('1E4a2E') and not is_valid_password('1E8a2') and not is_valid_password('1EDA2E') and not is_valid_password('1eda2e') and not is_valid_password('sedEfe') and not is_valid_password('sedEf!') and not is_valid_password('sedEf7') else '\033[91m❌KO\033[00m')
