...
print('\033[92m✓ OK' if are_equal_strings("test", "TEST") and are_equal_strings("test", "test") and are_equal_strings("TeST", "TEsT") and not are_equal_strings("test", "teste") else '\033[91m❌KO')
