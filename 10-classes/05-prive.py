...
my_instance._letter  # INTERDIT ! Underscore = variable privée
...
# que la logique interne de la classe à le droit de changer sans que le reste
# de votre ne programme ne soit impacté.
...
print('\033[92m✓ OK\033[00m' if get_oldest(test_adult, test_child) == "bob doe" and test_adult._firstname == "bob" and test_adult._lastname == "doe" and test_adult._age == 18 and test_adult._is_adult() else '\033[91m❌KO\033[00m')