...
print('\033[92m✓ OK\033[00m' if test.get_full_name() == "bob doe" and test._school == "cnam" and test._level == 3 and test.has_degree() and not test_bis.has_degree() else '\033[91m❌KO\033[00m')