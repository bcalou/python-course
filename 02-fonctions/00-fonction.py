...
# L'intérieur de la fonction est "indenté" : on commence chaque ligne par 4
# espaces. Quand on sort de la fonction, on revient à l'identation normale.

# Il n'y a pas de validation pour cet exercice, mais votre but est d'appeler la
# fonction.
