...
# Le code suivant définit un objet Town.
...
# Creéz ensuite les variables "paris", "bordeaux" et "casablanca"
...
print('\033[92m✓ OK\033[00m' if paris["name"] == "Paris" and paris["is_capital"] and paris["country"]["name"] == "France" and paris["country"]["is_eu_member"] and bordeaux["name"] == "Bordeaux" and not bordeaux["is_capital"] and bordeaux["country"]["name"] == "France" and bordeaux["country"]["is_eu_member"] and casablanca["name"] == "Casablanca" and not casablanca["is_capital"] and casablanca["country"]["name"] == "Maroc" and not casablanca["country"]["is_eu_member"] else '\033[91m❌KO\033[00m')
