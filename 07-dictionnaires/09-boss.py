# Félicitations, vous êtes propriétaire d'une pizzeria.
...
def get_cost_for_order(pizzas: list[Pizza]) -> int:
    """Compute the cost for all the pizzas in the given order"""
    return 0
...
print('\033[92m✓ OK\033[00m' if get_cost_for_order(order1) == 13 and get_cost_for_order(order2) == 35 else '\033[91m❌KO\033[00m')
