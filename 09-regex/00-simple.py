...
# Note : il existe une syntaxe pour transformer un résultat de match en booléen
...
print('\033[92m✓ OK\033[00m' if contains("hello", "hello world") and not contains("goodbye", "hello world") else '\033[91m❌KO\033[00m')
