...
# Utilisez https://regex101.com/ pour construire votre regex.
# Dans "Test string", copiez les mails ci-dessus pour voir ceux qui sont
# matchés.
...
# vastes ! Pour info, voici la "vraie" regex. Sympathique, n'est-ce pas ?
...
for mail in invalid:
    if is_valid_mail(mail):
        error = True
print('\033[92m✓ OK\033[00m' if not error else '\033[91m❌KO\033[00m')
